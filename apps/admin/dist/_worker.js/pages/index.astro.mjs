...
const logoUrl = "/_astro/logo-wordmark-on-light.V-NV4s6q.svg";
...
}, "/app/apps/admin/src/layouts/Admin.astro", void 0);
...
}, "/app/apps/admin/src/pages/index.astro", void 0);

const $$file = "/app/apps/admin/src/pages/index.astro";
const $$url = "";
